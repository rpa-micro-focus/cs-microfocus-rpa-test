namespace: io.cloudslang.microfocus.oo.ssx.category.test
flow:
  ...
  workflow:
    ...
    - get_category:
        do:
          io.cloudslang.microfocus.oo.ssx.category.get_category:
            - token: '${token}'
    ...
    - get_category_by_id:
        do:
          io.cloudslang.microfocus.oo.ssx.category.get_category_by_id:
            - token: '${token}'
            - category_id: '${category_id}'
        navigate:
          - FAILURE: SUCCESS
